--we created shema for the customers table
...
--we created a schema for the category table
...
--we created a schema for the products table
...
--we created the shema for orders table
CREATE TABLE Orders (
...
--we created the shema for OrderDetails table
...
--we insert data into customers table
...
--we insert data into the categories table
...
--we insert data into products table
...
--we insert data into Orders table
...
--we insert data into OrderDetails table
